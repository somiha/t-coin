...
export default function SavingsDetails() {
  return (
    <div className="p-6">
      <h2 className="text-xl font-semibold mb-4">Savings Details</h2>
      ...
      <Card className="w-full">
        <CardContent className="p-6 space-y-6 lg:pl-16 md:pl-1">
          ...
          <div className="w-full max-w-[600px]">
            <Label htmlFor="type" className="block mb-4 text-md font-medium">
              Savings Type
            </Label>
            <Input id="type" value="Monthly" readOnly />
          </div>
